...
| Gemini 3.1 Pro    | API or browser | `gemini-3.1-pro`        | "Gemini 3.1 Pro"            | Multimodal, extended thinking in browser        |
| Gemini 3.5 Flash  | browser        | `gemini-3.5-flash`      | "Gemini 3.5 Flash"          | Fast Gemini Web checks                          |
| Gemini 3.1 Flash-Lite | browser    | `gemini-3.1-flash-lite` | "Gemini 3.1 Flash-Lite"     | Lightweight Gemini Web checks                   |
...
- **Gemini 3.1 Pro** (browser): free with a Google account.
