...
oracle -p "Cross-check the data layer assumptions" \
  --models gpt-5.5-pro,gemini-3.1-pro,claude-4.6-sonnet \
  --file "src/**/*.ts"
...
- **One CLI to a stable of pro agents.** GPT-5.5 Pro (default), GPT-5.5, GPT-5.4 Pro, GPT-5.4, GPT-5.2 Pro, GPT-5.1 Pro, GPT-5.1 Codex, Gemini Web models (`gemini-3.1-pro`, `gemini-3.5-flash`, `gemini-3.1-flash-lite`), Claude Sonnet 4.6, Claude Opus 4.1 — plus any OpenRouter id.
