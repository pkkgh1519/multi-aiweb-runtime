...
oracle --preflight --models gpt-5.4,claude-4.6-sonnet,gemini-3.1-pro -p "..."
```
...
```sh
oracle --route --models gpt-5.4,gemini-3.1-pro
...
```sh
oracle --models gpt-5.4,claude-4.6-sonnet,gemini-3.1-pro --allow-partial ...
...
- gemini-3.1-pro: auth failed, API key expired
