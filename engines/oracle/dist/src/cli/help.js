...
function renderHelpFooter(program, colors) {
    ...
    const examples = [
        ...
        formatExample(`${program.name()} --prompt "Cross-check the data layer assumptions" --models gpt-5.2-pro,gemini-3.1-pro --file "src/**/*.ts"`, "Run multiple API models in one go and aggregate cost/usage."),
